export const portfolioData = {
  profile: {
    ...
    title: "Data/Control Systems Engineer",
    tagline: "Battery Modeling & Analytics | Full-Stack/Data Engineering",
    ...
    summary: "Engineer with ~2 years combined experience across data/analytics engineering, control systems, and battery modeling. Builds reproducible pipelines (PySpark/Delta/dbt/Airflow), ML prototypes (scikit-learn/XGBoost/PyTorch), and physics-based Li-ion models (SPMe/DFN in PyBaMM). Comfortable across Python/SQL/JS/Java, CI/CD (GitHub Actions), containers (Docker), and dashboards (Power BI/Streamlit). Proven track record shipping portfolio projects, mentoring as a TA, and delivering measurable ops/quality improvements in telco network analytics.",
