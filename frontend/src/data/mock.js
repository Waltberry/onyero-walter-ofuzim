...
export const portfolioData = {
  profile: {
    ...
    title: "Electrical & Software Engineer • Data, Controls & Network Systems",
    tagline:
      "System Identification • Data & Software Engineering • Battery Modeling • Network Analytics & Automation",
    ...
    summary:
      "Engineer with 6+ years of combined professional and research experience spanning network operations, data analytics and automation, control systems, battery modeling, and software engineering. At MTN Nigeria, I progressed from Network Operations/Support Engineering Intern through Network Engineer and Network Support Analyst roles to Lead Technology Specialist, working across network operations, reliability, KPI analytics, Python automation, Linux/Bash, SNMP, Excel, and Power BI. I completed an M.Sc. in Electrical & Software Engineering at the University of Calgary in August 2026, with research focused on physics-based lithium-ion battery modeling, system identification, parameter estimation, and degradation monitoring. I also build portfolio projects across data engineering and lakehouses, backend APIs, cloud/Kubernetes, QA automation, ML, and industrial controls, with an emphasis on reproducibility, testing, clear documentation, and practical engineering delivery.",
    availability: "Available immediately • Open to full-time opportunities across Canada",
    quickFacts: [
      "Canada work-eligible • Open to relocate across Canada",
      "M.Sc. Electrical & Software Engineering • University of Calgary • Completed Aug 2026 • GPA 3.85",
      "6+ years combined professional and research experience across networking, analytics, automation, controls, and engineering research",
      "Strengths: ownership, clear documentation, testable code, analytical problem-solving, and practical engineering judgement",
    ],
  },
  ...
  experience: [
    {
      ...
      highlights: [
        "Developed a physics-informed system identification framework for lithium-ion battery degradation monitoring using experimental current-voltage measurements",
        "Designed structured SPMe-inspired state-space models representing solid-phase diffusion and electrolyte dynamics, with interpretable internal parameters",
        "Implemented multi-stage parameter-estimation and system-identification pipelines in Python/JAX using nonlinear optimization and synthetic validation experiments",
        "Built automated pipelines for battery data ingestion, discharge-cycle detection, signal preprocessing, per-cycle parameter estimation, and degradation trend analysis",
        "Analyzed resistance evolution, parameter drift, model residuals, and nonlinear voltage behavior across battery cycling data",
        "Developed reproducible research software using Python, JAX, NumPy, SciPy, PyTest, Git, and modular experiment/visualization tooling",
        "TA for controls, optimization, software engineering, computer organization, electronics, electric-machine control, and embedded/computer architecture courses",
      ],
    },
    {
      id: 2,
      title: "Network Operations / Support Engineer → Network Engineer → Network Support Analyst → Lead Technology Specialist",
      company: "MTN Nigeria",
      department: "NSMC (Nov 2019 – Jul 2022) → NPQA / Core Performance (Aug 2022 – Nov 2023)",
      location: "Lagos, Nigeria",
      dates: "Nov 2019 – Nov 2023",
      highlights: [
        "Progressed through four roles at MTN Nigeria, from Network Operations/Support Engineering Intern to Network Engineer, Network Support Analyst, and Lead Technology Specialist",
        "Supported network operations within NSMC across TX/IP MPLS, Data & Internet Services, NSS, SNMP monitoring, fault escalation, capacity monitoring, and operational reporting",
        "Transitioned to Network Performance Quality Assurance (NPQA), Core Performance, focusing on network reliability, performance analytics, fault management, and service-quality monitoring",
        "Analyzed network performance, fault, capacity, and service-quality datasets to identify recurring reliability issues, degradation patterns, and optimization opportunities",
        "Built Python, Excel, and Power BI workflows to automate KPI monitoring, trend analysis, incident review, and management-level performance reporting",
        "Worked with Linux, Bash, SNMP, StableNet, and network-monitoring systems for troubleshooting, performance analysis, and proactive network health monitoring",
        "Led and mentored a 5-person analyst team during the later stage of the role, supporting KPI analysis, incident investigation, reporting, and operational decision-making",
        "Collaborated with network engineering, operations, and performance teams to investigate anomalies, escalate confirmed risks, document recurring issues, and improve service reliability",
      ],
    },
    {
      id: 3,
  ...
  education: [
    {
      ...
      dates: "Jan 2024 – Aug 2026",
      gpa: "3.85",
      status: "Completed Aug 2026 • Thesis defended Aug 6, 2026",
      focus: [
        "Advanced Control & System Identification",
        "Physics-Informed Battery Modeling",
